...
def register_universe_main():
    ...
    equity_prices = pd.read_csv(filtered_path + "final_eq_full.csv") # file not exist yet
    equity_prices.set_index('Unnamed: 0', inplace=True)  #'Unnames: 0' not exist 
    # suggest replace line 19-20 to line 22 below:
